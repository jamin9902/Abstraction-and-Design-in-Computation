...
let cSTEP_SIZE_VACCINATED = cSTEP_SIZE_SUSCEPTIBLE ;;
...
let cINFECTIOUSNESS_VACCINATED = 0.0 ;;
...
(* proportion of susceptible that become vaccinated on any given time step *)
let cVACCINATION_FREQ = 1. /. 500. ;;
...
let cCOLOR_VACCINATED = 0x66ff00 ;;
